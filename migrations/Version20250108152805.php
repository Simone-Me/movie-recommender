 ...
 */
final class Version20250108152805 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie DROP tmdb_id, CHANGE id id INT NOT NULL, CHANGE poster_path poster_path VARCHAR(255) DEFAULT \'NULL\', CHANGE release_date release_date DATE DEFAULT \'NULL\', CHANGE vote_average vote_average NUMERIC(3, 1) DEFAULT \'NULL\', CHANGE revenue revenue NUMERIC(20, 2) DEFAULT \'NULL\', CHANGE genres genres LONGTEXT DEFAULT \'NULL\' COMMENT \'(DC2Type:array)\', CHANGE original_language original_language VARCHAR(255) DEFAULT \'NULL\', CHANGE production_countries production_countries VARCHAR(255) DEFAULT \'NULL\', CHANGE budget budget NUMERIC(20, 2) DEFAULT \'NULL\'');
    }
}
